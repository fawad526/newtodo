...
export default function Signup() {
    ...
    return (
        <div className="flex flex-col items-center justify-center px-6 pt-4 lg:pt-8 mx-auto h-screen bg-cover ">
            <Link href="/">
            ...
            <div className="items-center justify-center w-full bg-white rounded-lg shadow lg:flex md:mt-0 lg:max-w-screen-md xl:p-0">
                <div className="w-full p-6 space-y-8 sm:p-8 lg:p-16">
                    <h2 className="text-2xl font-bold text-gray-900 lg:text-3xl">Create  Account</h2>
